...
const Packages = () => {
  // const phoneNumber = '+923131933119';
                ...
                <div className="single-price">
                  ...
                  <div className="price-content">
                    <ul>
                      ...
                      <li>
                        <i className="fa fa-check-circle"></i>Quran Reading &
                        Recitation
                      </li>
                      <li>
                      ...
                      <li>
                        <i className="fa fa-times-circle"></i> Seerah & Islamic
                        Studies
                      </li>
                      <li>
                        <i className="fa fa-times-circle"></i> Quran
                        Memorization
                      </li>
                      <li>
                        <i className="fa fa-times-circle"></i> Full learning
                        programme for kids or adults
                      </li>
                    </ul>
                  </div>
                  <div className="price-button">
                    <a href={whatsappLink} target="_blank" className="buy-btn">
                      Call Now
                    </a>
                  </div>
                  <h6>All prices are in GBP</h6>
                  <p>
                    ** Discounts, special pricing and volume discounts are
                ...
                <div className="single-price">
                  ...
                  <div className="price-content">
                    <ul>
                      ...
                      <li>
                        <i className="fa fa-check-circle"></i> Quran
                        Memorization
                      </li>
                      <li>
                        <i className="fa fa-check-circle"></i> Seerah & Islamic
                        Studies
                      </li>
                      <li>
                        <i className="fa fa-check-circle"></i> Full learning
                        programme for kids or adults
                      </li>
                    </ul>
                  </div>
