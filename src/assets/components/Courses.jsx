  ...
  return (
    <>
      <div className="courses">
        ...
        <div className="cards">
          <div className="card1">
            <img src="/src/assets/images/course-img1.png" alt="" height="300" />
          ...
          <div className="card2">
            <img src="/src/assets/images/course-img2.png" alt="" height="300" />
            <h1>تجويد القرآن</h1>
          ...
          <div className="card3">
            <img src="/src/assets/images/course-img3.png" alt="" height="300" />
            <h1>حفظ القرآن</h1>
          ...
          <div className="card4">
            <img src="/src/assets/images/course-img6.png" alt="" height="300" />
